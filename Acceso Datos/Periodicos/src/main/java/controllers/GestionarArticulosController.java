...
import servicios.implServicios.ServiciosPeriodicosImpl;
import servicios.implServicios.ServiciosAutoresImpl;
import servicios.implServicios.ServiciosArticulosImpl;
...
public class GestionarArticulosController implements Initializable {
    ...
    @FXML
    private TextField textAutorAdd;
    @FXML
